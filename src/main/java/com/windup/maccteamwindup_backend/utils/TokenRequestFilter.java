//package com.windup.maccteamwindup_backend.utils;
...
//        try {
//            //if ("/login".equals(request.getRequestURI()) || "/signUp".equals(request.getRequestURI()) || "/upload".equals(request.getRequestURI())) {
//            if (true) {
